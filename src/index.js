...
import emoji from "./static/emoji.json" assert { type: "json" };
...
var array_coco = fs
  .readFileSync("./static/list_coco.txt")
  .toString()
  .split("\n");
var array_coco2 = fs
  .readFileSync("./static/list_coco2.txt")
  .toString()
  .split("\n");
var array_pepe = fs
  .readFileSync("./static/list_pepe.txt")
  .toString()
  .split("\n");
var array_elaina = fs
  .readFileSync("./static/list_elaina.txt")
  .toString()
  .split("\n");
var array_animal = fs
  .readFileSync("./static/list_animal.txt")
  .toString()
  .split("\n");
var array_list = fs.readFileSync("./static/list.txt").toString().split("\n");
...
client.on("messageCreate", async (message) => {
  ...
  if (message.content == selectEmoji) {
    return;
  } else if (
